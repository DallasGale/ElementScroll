  ...
  window.addEventListener("scroll", function (e) {
    ...
    if (referenceElement.getBoundingClientRect().y < 0) {
      window.addEventListener("scroll", function () {
        ...
        var formattedCurrentValue = Math.abs(currentValue).toFixed(2);
        console.log("formattedCurrentValue", formattedCurrentValue);
        var number = (0, _functions.FormatToPercent)((0, _functions.ConvertNumberToPercentage)(formattedCurrentValue, 5000));
        var output = Math.abs(number).toFixed(4);
...
},{"./functions":"functions.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
