...
function getWindowHeight(output) {
  if (resize_observer_polyfill_1.default) {
...
exports.setScrollerPositions = function scrollHandler(size, referenceElement, scroller, percentageScrolled) {
  ...
  if (progress > STATUS.states.snapToStart && progress < STATUS.states.snapToEnd) {
    ...
    return;
  } else if ( // When scroller is at the START positions.
  progress > STATUS.states.start && progress < STATUS.states.snapToStart) {
...
},{"rxjs":"node_modules/rxjs/_esm5/index.js","rxjs/operators":"node_modules/rxjs/_esm5/operators/index.js","./handlers":"scripts/handlers.ts","./functions":"scripts/functions.ts"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
